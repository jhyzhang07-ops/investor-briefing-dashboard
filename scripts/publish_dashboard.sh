...
git add index.html styles.css app.js README.md .nojekyll assets/market-hero.png data/briefings-data.js data/a-share-briefings-data.js data/weekly-briefings-data.js data/a-share-weekly-briefings-data.js scripts/archive_briefing.py scripts/serve_local.sh scripts/publish_dashboard.sh scripts/auto_publish_once.sh scripts/install_auto_publish.sh scripts/uninstall_auto_publish.sh
