(function () {
  const MARKET_CONFIGS = {
    us: {
      ...
      weeklySource: () => window.WEEKLY_MARKET_BRIEFINGS,
      ...
      noWeeklyDescription: "This weekly briefing has not been archived yet. The Sunday 8:00 AM automation will add weekly reviews here.",
    ...
    cn: {
      ...
      weeklySource: () => window.A_SHARE_WEEKLY_BRIEFINGS,
      ...
      noDateDescription: "Select a marked calendar date, use Latest, or wait for the next scheduled 8:00 AM run.",
      noWeeklyDescription: "本周周报还没有归档。周日早上8点的自动化会把周度复盘加入这里。",
